...
<summary style="background: #21262d; color: #f0f6fc; padding: 8px 12px; cursor: pointer; font-weight: 500; font-size: 0.9em; border-radius: 4px 4px 0 0; display: flex; align-items: center; gap: 6px; border: none;">
  <span>🔧</span>
  <span>10. Network Troubleshooting After AD Installation</span>
</summary>
<div style="padding: 12px; background: #161b22; color: #e6edf3; border-radius: 0 0 4px 4px;">

<div style="color: #58a6ff; font-weight: 600; margin-bottom: 8px;">Overview</div>
Common network connectivity issues after Active Directory installation and how to fix them. This is a very common problem that can be easily resolved.

<div style="color: #58a6ff; font-weight: 600; margin: 12px 0 8px 0;">🚨 Most Common Issue: DNS Configuration</div>
<div style="background: #0d1117; padding: 12px; border-radius: 6px; border: 1px solid #30363d; margin: 8px 0;">
<div style="color: #e6edf3; margin-bottom: 8px;"><span style="color: #f85149; font-weight: 600;">Problem:</span> After AD installation, server can't reach the internet or other computers can't reach the server.</div>
<div style="color: #e6edf3; margin: 8px 0;"><span style="color: #58a6ff; font-weight: 600;">Root Cause:</span> DNS settings are pointing to the new AD server instead of external DNS servers.</div>
</div>

<div style="color: #58a6ff; font-weight: 600; margin: 12px 0 8px 0;">🔧 Step 1: Check Current DNS Settings</div>
<div style="background: #0d1117; padding: 12px; border-radius: 6px; border: 1px solid #30363d; margin: 8px 0;">
<div style="color: #e6edf3; margin-bottom: 8px;"><span style="color: #58a6ff; font-weight: 600;">Open Command Prompt as Administrator and run:</span></div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">ipconfig /all</div>
<div style="color: #e6edf3; margin: 8px 0;">Look for "DNS Servers" - if it only shows your server's IP (like 192.168.1.10), that's the problem.</div>
</div>

<div style="color: #58a6ff; font-weight: 600; margin: 12px 0 8px 0;">🔧 Step 2: Fix DNS Settings</div>
<div style="background: #0d1117; padding: 12px; border-radius: 6px; border: 1px solid #30363d; margin: 8px 0;">
<div style="color: #e6edf3; margin-bottom: 8px;"><span style="color: #58a6ff; font-weight: 600;">Method 1: Through Network Settings</span></div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">1. Right-click network icon in system tray</div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">2. Open Network & Internet settings</div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">3. Click "Change adapter options"</div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">4. Right-click your network adapter → Properties</div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">5. Select "Internet Protocol Version 4 (TCP/IPv4)" → Properties</div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">6. Set DNS servers to:</div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">   - Preferred: 8.8.8.8</div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">   - Alternate: 8.8.4.4</div>
</div>

<div style="color: #58a6ff; font-weight: 600; margin: 12px 0 8px 0;">🔧 Step 3: Configure DNS Forwarders on AD Server</div>
<div style="background: #0d1117; padding: 12px; border-radius: 6px; border: 1px solid #30363d; margin: 8px 0;">
<div style="color: #e6edf3; margin-bottom: 8px;"><span style="color: #58a6ff; font-weight: 600;">Open DNS Manager:</span></div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">1. Open Server Manager</div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">2. Click "Tools" → "DNS"</div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">3. Right-click your server name → Properties</div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">4. Click "Forwarders" tab</div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">5. Click "Edit" and add:</div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">   - 8.8.8.8</div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">   - 8.8.4.4</div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">6. Click "OK" to save</div>
</div>

<div style="color: #58a6ff; font-weight: 600; margin: 12px 0 8px 0;">🔧 Step 4: Test Network Connectivity</div>
<div style="background: #0d1117; padding: 12px; border-radius: 6px; border: 1px solid #30363d; margin: 8px 0;">
<div style="color: #e6edf3; margin-bottom: 8px;"><span style="color: #58a6ff; font-weight: 600;">Test Commands:</span></div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">ping google.com</div>
<div style="color: #e6edf3; margin: 4px 0; font-size: 0.9em;">Should return responses from Google's servers</div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">nslookup google.com</div>
<div style="color: #e6edf3; margin: 4px 0; font-size: 0.9em;">Should resolve Google's IP address</div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">ipconfig /flushdns</div>
<div style="color: #e6edf3; margin: 4px 0; font-size: 0.9em;">Clears DNS cache</div>
</div>

<div style="color: #58a6ff; font-weight: 600; margin: 12px 0 8px 0;">🔧 Alternative: PowerShell Method</div>
<div style="background: #0d1117; padding: 12px; border-radius: 6px; border: 1px solid #30363d; margin: 8px 0;">
<div style="color: #e6edf3; margin-bottom: 8px;"><span style="color: #58a6ff; font-weight: 600;">Run PowerShell as Administrator:</span></div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;"># Get current network adapter</div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">Get-NetAdapter</div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;"># Set DNS servers (replace "Ethernet" with your adapter name)</div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">Set-DnsClientServerAddress -InterfaceAlias "Ethernet" -ServerAddresses 8.8.8.8,8.8.4.4</div>
</div>

<div style="color: #58a6ff; font-weight: 600; margin: 12px 0 8px 0;">🚨 Other Common Issues</div>
<div style="display: grid; gap: 8px; margin-left: 8px;">
<div style="background: #0d1117; padding: 12px; border-radius: 6px; border: 1px solid #30363d;">
<div style="color: #f85149; font-weight: 600; margin-bottom: 6px;">Issue: Can't access internet at all</div>
<div style="color: #e6edf3; font-size: 0.9em;"><span style="color: #58a6ff;">Solution:</span> Check if your router/gateway IP is set as the default gateway in network settings</div>
</div>
<div style="background: #0d1117; padding: 12px; border-radius: 6px; border: 1px solid #30363d;">
<div style="color: #f85149; font-weight: 600; margin-bottom: 6px;">Issue: Other computers can't join the domain</div>
<div style="color: #e6edf3; font-size: 0.9em;"><span style="color: #58a6ff;">Solution:</span> Ensure other computers have the AD server's IP as their DNS server</div>
</div>
<div style="background: #0d1117; padding: 12px; border-radius: 6px; border: 1px solid #30363d;">
<div style="color: #f85149; font-weight: 600; margin-bottom: 6px;">Issue: Slow network performance</div>
<div style="color: #e6edf3; font-size: 0.9em;"><span style="color: #58a6ff;">Solution:</span> Check if Windows Firewall is blocking traffic, verify network adapter drivers</div>
</div>
</div>

<div style="color: #58a6ff; font-weight: 600; margin: 12px 0 8px 0;">✅ Quick Fix Checklist</div>
<div style="display: grid; gap: 6px; margin-left: 8px;">
<div style="display: flex; align-items: center; gap: 8px;"><span style="color: #7c3aed;">1️⃣</span><span><span style="color: #f85149;">Check DNS settings</span> - Should point to external DNS (8.8.8.8)</span></div>
<div style="display: flex; align-items: center; gap: 8px;"><span style="color: #7c3aed;">2️⃣</span><span><span style="color: #f85149;">Configure DNS forwarders</span> - On AD server for internet resolution</span></div>
<div style="display: flex; align-items: center; gap: 8px;"><span style="color: #7c3aed;">3️⃣</span><span><span style="color: #f85149;">Test connectivity</span> - ping google.com</span></div>
<div style="display: flex; align-items: center; gap: 8px;"><span style="color: #7c3aed;">4️⃣</span><span><span style="color: #f85149;">Flush DNS cache</span> - ipconfig /flushdns</span></div>
<div style="display: flex; align-items: center; gap: 8px;"><span style="color: #7c3aed;">5️⃣</span><span><span style="color: #f85149;">Restart services</span> - Restart DNS and network services</span></div>
</div>

<div style="color: #58a6ff; font-weight: 600; margin: 12px 0 8px 0;">🔄 Restart Network Services</div>
<div style="background: #0d1117; padding: 12px; border-radius: 6px; border: 1px solid #30363d; margin: 8px 0;">
<div style="color: #e6edf3; margin-bottom: 8px;"><span style="color: #58a6ff; font-weight: 600;">If problems persist, restart these services:</span></div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;"># In PowerShell as Administrator</div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">Restart-Service DNS</div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">Restart-Service Dnscache</div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;">Restart-Service Netlogon</div>
<div style="color: #f85149; font-family: monospace; margin: 4px 0;"># Or restart the entire server</div>
</div>

<div style="background: #0d1117; padding: 12px; border-radius: 6px; border: 1px solid #30363d; margin: 12px 0; text-align: center;">
<div style="color: #58a6ff; font-weight: 600; margin-bottom: 8px;">💡 Pro Tip</div>
<div style="color: #e6edf3; font-size: 0.95em;">This DNS issue happens because AD installation changes your server to be a DNS server, but it doesn't automatically configure internet forwarding. The fix is usually just adding external DNS forwarders!</div>
</div>
